...
export declare function getSelectedConnector(...initializedConnectors: [Connector, Web3ReactHooks][] | [Connector, Web3ReactHooks, Web3ReactStore][]): {
    ...
    useSelectedENSNames: (connector: Connector, provider?: BaseProvider | undefined) => (string | null)[] | undefined;
...
export declare function getPriorityConnector(...initializedConnectors: [Connector, Web3ReactHooks][] | [Connector, Web3ReactHooks, Web3ReactStore][]): {
    ...
    usePriorityENSNames: (provider?: BaseProvider | undefined) => (string | null)[] | undefined;
...
declare function getAugmentedHooks<T extends Connector>(connector: T, { useAccounts }: ReturnType<typeof getStateHooks>, { useAccount, useIsActive }: ReturnType<typeof getDerivedHooks>): {
    ...
    useENSNames: (provider?: BaseProvider | undefined) => (string | null)[] | undefined;
    useENSName: (provider?: BaseProvider | undefined) => (string | null) | undefined;
};
export {};
